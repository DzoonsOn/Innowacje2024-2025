    ...
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <div className="modal-buttons">
          <button onClick={onConfirm} className="confirm-button"><Link href={`/Categories/${productCategory}`}>Potwierdź</Link></button>
...
const Product = ({ shortageId, productName, shelfUnit, shelfNumber, productNumber, productCategory}) => {
  ...
  return (
    <div className='mx-auto bg-white rounded-lg shadow-md p-4 border my-2'>
      ...
      {isModalOpen && <Modal onClose={handleModalClose} onConfirm={handleModalConfirm} productCategory={productCategory}/>}
    </div>
  )
}
